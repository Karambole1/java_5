...
public class Main {
    public static void main(String[] args) throws IOException, Battery_Error{
        ...
        while (true) {
            ...
            if (answer.charAt(0) == '1') {
                ...
                if (answer.charAt(0) == '1') {
                    ...
                    System.out.println("\n");
                    device.set_Evaporator(evaporators[Integer.parseInt(answer) - 1]);
                    evaporators[Integer.parseInt(answer) - 1].Watts_division_resistance(helpp);
                    System.out.println("Watts/resistance: " + helpp.helpp + "\n");
                    System.out.println("\nPress any key to continue...");
                    reader.readLine();
                }
                    ...
                    try {
                        if (batteries[4] != null) {
                            ...
                            System.out.println("battery 5's capacity:\n" + battery_5_capacity);
                        }
                        else throw new Battery_Error();
                    }
                    catch (Battery_Error e) {
                        System.out.println("battery 5's capacity: Error");
                    }
                    System.out.println("\n6 Remove added parts.\n");
                ...
                int baterry_slots = 3, slots = 3;
                Battery [][] all_avalibale_baterries = new Battery[slots][baterry_slots];
                all_avalibale_baterries[0][0] = new Battery("cool_battery", 12, 10);
                all_avalibale_baterries[0][0].Battery_INFO();
                all_avalibale_baterries[0][0].set_mAh(50);
